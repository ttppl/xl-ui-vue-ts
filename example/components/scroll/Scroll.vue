<template>
  <div class="Scroll">
    ...
    <XlCategory title="" :category-style="{width:'250px',paddingLeft:'20px'}" :show-order="false" :fixed="false">
      ...
      <XlCategoryItem title="横向滚动条">
        <ExampleForm>
          <h3>横向滚动</h3>
          <p>设置固定宽度</p>
          <XlScroll class="scroll-x" width="500">
            <p>
              壬戌之秋，七月既望，苏子与客泛舟，游于赤壁之下。
              清风徐来，水波不兴。
              举酒属客，诵明月之诗，歌窈窕之章。少焉，月出于东山之上，徘徊于斗牛之间。
