export default {
  position: `<XlPopover position="left" to-body inline>
...
<div class="popovers">
  ...
  popStyle: `<XlPopover :pop-style="{backgroundImage:'linear-gradient(to right bottom, #31EA41 , #ED9ADB)'}" inline>
  <template #reference><XlButton>背景渐变</XlButton></template>
  <p class="flex-jc-start">自定义渐变背景</p>
</XlPopover>`,
  overflow: `<XlPopover position="top" to-body height="400" width="400" inline>
